...
public class Day4 {
    ...
    private static String input = "98-99,3-97\n" +
            "23-72,23-72\n" +
            "53-62,8-87\n" +
            "21-52,36-51\n" +
            "36-38,37-96\n" +
    ...
    public static void main(String[] args) {
        ...
        for (String s : input.split("\\R")) {
            ...
            if (contains(r1Start, r1End, r2Start, r2End)) {
                numberOfContainments++;
            }

            if (overlaps(r1Start, r1End, r2Start, r2End)) {
                numerOfOverlaps++;
            }
        }

        System.out.println(numberOfContainments);
        System.out.println(numerOfOverlaps);
    }

    private static boolean contains(int aStart, int aEnd, int bStart, int bEnd) {
